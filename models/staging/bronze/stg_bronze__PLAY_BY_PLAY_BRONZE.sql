...
source as (
    ...
    select * from {{ source('raw', 'PLAY_BY_PLAY_RAW') }}
...
renamed as (
    ...
    select
        ...
        -- Create home and away team name as game_home/away_team by grouping by game_id and finding unique values in play_team.
        -- Clean up game_time
